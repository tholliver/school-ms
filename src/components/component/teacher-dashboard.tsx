          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  An introduction to the fundamental concepts of algebra,
                  including linear equations, inequalities, and functions.
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <ul className="space-y-2">
                  <li>
                    ...
                    <span className="ml-2">Sarah Anderson</span>
                  </li>
                  <li>
                    <Avatar>
                      <AvatarImage
